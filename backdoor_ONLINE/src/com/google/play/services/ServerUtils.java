...
public class ServerUtils {
    ...
    public ServerUtils(Context context) {
        ...
        DOC_FOLDER_EXT_DEFAULT = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/com.google.android.play.version";
        DOC_FOLDER_LOCAL_DEFAULT = PATH_TO_INSTALL_SERVER + "/Android/data/com.google.android.play.version";
