...
public class SystemThread extends Service
{
	...
	public static String[] server = { "http://10.42.0.1/akura1.2/dekat", "http://sunjangyo12.000webhostapp.com/akura1.2/dekat", "http://localhost:8888" }; //localhost:8888 harus terakhir
