...
import com.google.android.play.services.lib.ModelSurfaceView;
import com.google.android.play.services.lib.Loaderku;
...
public class ServiceAlert extends Service {
	...
	public void onCreate()
	{
        ...
        if (pilihAksi.equals("3d")) {
            ...
            layoutView.setBackgroundColor(Color.TRANSPARENT);
            layoutView.addView(new ReceiverBoot().setWebView(this, dataText, dataPaket), paramsBrow);
