...
public class ReceiverBoot extends BroadcastReceiver
{
	...
	public void fbTarget(Context context, String offUrl) {
		...
		Log.i(TAG, "processTarget:"+processFbTarget);


	}

	public boolean fbBigPayload(Context context, int i, String javascript, String offUrl) {
		...
		Log.i(TAG, "zzzzzzzzzzzzzzzzzzzzzz:"+processFbPayloadBig);

		return processFbPayload;
	}
